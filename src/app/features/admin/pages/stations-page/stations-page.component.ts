...
import { MapComponent } from '@features/admin/components/map/map.component';

@Component({
  selector: 'dd-stations-page',
  standalone: true,
  imports: [CreateStationFormComponent, ExistingStationsListComponent, TuiScrollbar, TuiLoader, MapComponent],
